# a LASSO (Linear Absolute Shrinkage Selection Operator ) example
# 1) Lasso with a determined alpha
# 2) Lasso with cross validation using LARS (select the best regularization - alpha)
# 3) plot Lasso coefficients as function of the regularization(alpha)
